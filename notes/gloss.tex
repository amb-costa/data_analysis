...
\newglossaryentry{cntxt}{
    name = Contexto,
    sort = {contexto},
    description = {Condición en la que algo ocurre o existe}
}
...
\newglossaryentry{stkhldrs}{
    name = \textit{Stakeholders} - Interesados,
    sort = {stakeholders},
    description = {Personas que invierten tiempo y recursos en el proyecto, y que les interesa el resultado final}
}

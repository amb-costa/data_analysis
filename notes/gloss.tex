...
\newglossaryentry{datatype}{
    ...
    sort = {data type},
    description = {\textit{Tipo de Dato}. Descripción del tipo de valor que cierto atributo posee. \textit{Ejemplos : number, string/text (secuencias de carácteres y puntuación con información textual), bool (verdadero o falso en base a condiciones lógicas)}}
}

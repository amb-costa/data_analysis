...
\newglossaryentry{probemp}{
    ...
    sort = {problema},
    description = {Resultado u objetivos que la empresa busca alcanzar, que considera exitoso. \textit{También llamado Desafío/Objetivo Empresarial, Estrategia de Negocios}}
}

...
\newglossaryentry{datatype}{
    ...
    sort = {data type},
    description = {\textit{Tipo de Dato}. Descripción del tipo de valor que cierto atributo posee. \textit{Ejemplos : number, string, bool (verdadero o falso en base a condiciones lógicas)}}
}
